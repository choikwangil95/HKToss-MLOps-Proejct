...
if predict_button:
    if selected_house == "주택명을 선택하세요":
        ...
        # 여기에 예측 코드 작성
        # score_low_predicted = predict_target('low', 'xgb', '0.0.1') # 최저당첨가점 예측
        # score_high_predicted = predict_target('high', 'xgb', '0.0.1') # 최고당첨가점 예측
        ...
        df_selected_house_predicted_view['최저당첨가점'] = 50  # 예측값(임시)
        df_selected_house_predicted_view['최고당첨가점'] = 60  # 예측값(임시)
